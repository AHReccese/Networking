...
NS_LOG_COMPONENT_DEFINE ("Lab3_part3");
...
std::string animFile = "lab3_part3.xml";
...
// changing the metric to [Last2DigitOfStudentNumber/10] + 3 
// my student Number is 96101635
// so the metric is : [35/10] + 3 = 6
...
p2p.EnableAsciiAll (ascii.CreateFileStream ("Lab3_part3.tr"));
p2p.EnablePcapAll ("Lab3_part3");
}
